  ...
  labor: {
    buildSystemPrompt({ context } = {}) {
      ...
      return [
        ...
        "- Prefer trade-specific role labels when the scope clearly supports them, such as Painter, Wallcovering Installer, Plumber, Striping Technician, Carpenter, Door Hardware Technician, Welder, Fabricator, Grinder, Laborer",
        ...
        "- Avoid splitting the same role into multiple rows unless the rows represent clearly different labor responsibilities",
        "- Consolidate duplicate same-role rows whenever one readable row can cover the work",
