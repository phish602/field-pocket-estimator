...
function buildSnapshot(overrides = {}) {
  const base = {
    ...
    "estipaid-customers-v1": JSON.stringify([{ id: "cust_1", name: "Acme Co" }, { id: "cust_2", name: "Beta Co" }]),
    "estipaid-projects-v1": JSON.stringify([{ id: "proj_1", customerId: "cust_1" }]),
    "estipaid-estimates-v1": JSON.stringify([{
      id: "est_1",
      projectId: "proj_1",
      customerId: "cust_1",
      estimateNumber: "EST-100",
      labor: { lines: [{ id: "est_line_1", description: "Labor", quantity: 1, rate: 25 }] },
    }]),
    "estipaid-invoices-v1": JSON.stringify([
      ...
      { id: "inv_2", projectId: "proj_1", customerId: "cust_1", invoiceNumber: "INV-101", invoiceTotal: 0, total: 0, amountPaid: 0, balanceRemaining: 0, payments: [] },
    ]),
