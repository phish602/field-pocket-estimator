...
test("Create -> Estimate opens Estimate Builder with no Estimate/Invoice toggle", () => {
  render(<App />);
...
test("Create -> Invoice (docType=invoice draft) opens Invoice Builder with no toggle", () => {
